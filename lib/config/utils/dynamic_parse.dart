...
class DynamicParse {
  ...
  static int? toIntOrNull(dynamic data) {
    ...
    try {
      ...
      if (kDebugMode) {
        ...
        log("DynamicParseError when trying to parse data of type ${data.runtimeType} to int");
  ...
  static double? toDoubleOrNull(dynamic data) {
    ...
    try {
      ...
      if (kDebugMode) {
        log("DynamicParseError general: $e");
        log("DynamicParseError when trying to parse data of type ${data.runtimeType} to double");
        log("DynamicParseError data: $data");
        if (forceCrash) rethrow;
      }
    }
  ...
  static num? toNumberOrNull(dynamic data) {
    ...
    try {
      ...
      if (kDebugMode) {
        log("DynamicParseError general: $e");
        log("DynamicParseError when trying to parse data of type ${data.runtimeType} to num");
        log("DynamicParseError data: $data");
        if (forceCrash) rethrow;
      }
    }
  ...
  static T? toObjectOrNull<T>(
    ...
    try {
      ...
      if (kDebugMode) {
        log("DynamicParseError general: $e");
        log("DynamicParseError when trying to parse data of type ${data.runtimeType} to $T");
        log("DynamicParseError data: $data");
        if (forceCrash) rethrow;
      }
    }
  ...
  static List<T> toList<T>(
    ...
    if (dataList is! Iterable) {
      if (kDebugMode) {
        log("DynamicParseError when trying to parse data of type ${dataList.runtimeType} to ${List<T>}");
    ...
    try {
      for (final item in dataList) {
        try {
          ...
          if (kDebugMode) {
            log("DynamicParseError general: $e");
            log("DynamicParseError when trying to parse data of type ${item.runtimeType} to $T");
